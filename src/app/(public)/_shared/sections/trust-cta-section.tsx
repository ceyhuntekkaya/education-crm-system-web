      ...
      <div className="container">
        ...
        <div className="trust-section__header">
          ...
          <h2 className="trust-section__title wow fadeInUp">
            Türkiye&apos;nin Lider Eğitim Kurumları{" "}
            <span className="text-gradient-main">Arasına Katılın</span>
          </h2>
          <p
            className="trust-section__subtitle wow fadeInUp"
            data-wow-delay="0.1s"
          >
            Dijital dönüşümünüzü başlatın, operasyonel yükünüzü hafifletin ve
            büyümenize odaklanın. Güvenilir altyapımız ile kurumunuzu geleceğe
            taşıyın.
          </p>
        </div>
        ...
        <div className="trust-cta wow fadeInUp" data-wow-delay="0.25s">
          <div className="trust-cta__inner">
            ...
            <div className="trust-cta__content">
              <div
                className="trust-cta__icon wow zoomIn"
              ...
              <h3
                ...
                data-wow-delay="0.3s"
              >
                Eğitimde Dijital Dönüşümü <span>Şimdi Başlatın</span>
              </h3>
              <p
                className="trust-cta__desc wow fadeInUp"
                data-wow-delay="0.35s"
              >
                Kurumsal üyeliğinizi oluşturun ve ayrıcalıklı özelliklere hemen
                erişin.
              </p>
              <div className="trust-cta__buttons">
                ...
                >
                  <i className="ph-bold ph-chats-circle d-flex text-lg" />
                  Demo Talep Edin
                </Link>
              </div>
            </div>
