              ...
              <div className="d-flex flex-column h-100">
                ...
                <div className="px-8 d-flex flex-column flex-grow-1">
                  ...
                  <div className="d-flex align-items-start gap-12 mb-16">
                    <div className="w-48 h-48 rounded-12 overflow-hidden flex-shrink-0 bg-neutral-50 border ">
                      {institution.logoUrl ? (
                        <Image
              ...
              <div className="content-fade-in position-relative">
                ...
                <div className="position-absolute top-0 end-0 p-16 z-3">
                  <Icon
                    ...
                    size="sm"
                    onClick={onCardClick}
                    // className="bg-white text-neutral-600 hover-bg-neutral-100 hover-text-neutral-800 box-shadow-sm"
                  />
                </div>
                    ...
                    <div className="pe-24">
                      ...
                      <div className="bg-white border rounded-16 p-24 box-shadow-sm">
                        ...
                        <div className="d-flex align-items-start gap-16 mb-20">
                          <div className="w-64 h-64 rounded-16 overflow-hidden flex-shrink-0 bg-neutral-50 border ">
                            {institution.logoUrl ? (
                              <Image
                                src={institution.logoUrl}
                                alt={`${
