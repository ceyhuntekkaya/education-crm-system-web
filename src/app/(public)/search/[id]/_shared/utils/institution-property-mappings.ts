/**
 * Institution property group icon mapping
 * Maps group names to their corresponding Phosphor icons
 */
export const getInstitutionPropertyGroupIcon = (groupName: string): string => {
...
/**
 * Institution property group color mapping
 * Maps group names to their corresponding Tailwind color classes
 */
export const getInstitutionPropertyGroupColor = (groupName: string): string => {
