...
/**
 * 🔍 SUPPLIER RFQ POPOVER FILTERS
 * Tedarikçi için Popover filter konfigürasyonları
 */
export const SUPPLIER_RFQ_POPOVER_FILTERS: PopoverFilterConfig[] = [
  {
    id: "status",
    fieldName: "status",
    label: "Durum",
...
export const createSupplierRFQPopoverFilters = (): PopoverFilterConfig[] =>
