...
export const AcceptModal: React.FC<AcceptModalProps> = ({
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} size="sm" variant="success">
      <ModalHeader title="Teklifi Kabul Et" onClose={onClose} />
      <ModalBody>
          ...
          <div className="d-flex align-items-start gap-8">
            ...
            <div>
              <small className="text-success-700 fw-medium d-block">
                Teklifi kabul ettikten sonra tedarikçi bilgilendirilecektir.
              </small>
            </div>
          </div>
        </div>
