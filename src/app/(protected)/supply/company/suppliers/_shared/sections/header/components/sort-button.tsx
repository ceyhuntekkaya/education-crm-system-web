        ...
        {isActive && (
          <>
            ...
            <button
              ...
              onMouseEnter={(e) => {
                e.currentTarget.style.backgroundColor = "hsl(var(--danger-50))";
                e.currentTarget.style.color = "hsl(var(--danger-700))";
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.backgroundColor = "transparent";
                e.currentTarget.style.color = "hsl(var(--danger-600))";
              }}
            >
              <i className="ph-bold ph-x" style={{ fontSize: "13px" }} />
            </button>
          </>
        )}
      </div>
