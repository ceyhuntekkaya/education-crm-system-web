...
import { useTeacherEventsContext } from "../contexts/events-context";
import {
...
export const TeacherEventCard: React.FC<TeacherEventCardProps> = ({
  event,
}) => {
  ...
  const { registeredEventIds } = useTeacherEventsContext();
          ...
          <div className="mt-12">
            {isRegistered ? (
              ...
              <Button
                ...
                fullWidth
                onClick={() =>
                  router.push(`/individual/teacher/events/register/${event.id}`)
                }
