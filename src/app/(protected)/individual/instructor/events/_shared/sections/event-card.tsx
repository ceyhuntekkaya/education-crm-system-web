...
/** Başlangıç ve bitiş tarihlerini akıllıca formatlar */
  ...
  const content = (
    ...
    >
      ...
      <div className="p-16 p-md-20 d-flex flex-column flex-grow-1">
        ...
        {/* Online link */}
        {event.onlineLink && event.deliveryFormat !== "IN_PERSON" && (
          <div className="d-flex align-items-center gap-8 mb-8 text-sm text-neutral-600">
            <i className="ph ph-link text-primary-400" />
            <span className="text-truncate">{event.onlineLink}</span>
          </div>
        )}
