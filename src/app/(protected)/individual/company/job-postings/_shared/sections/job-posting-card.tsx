...
export const JobPostingCard: React.FC<JobPostingCardProps> = ({
  ...
  const isClosed = jobPosting.status === "CLOSED";
  const isCompleted = jobPosting.status === "COMPLETED";
  ...
  const content = (
    ...
    >
        ...
        {(isClosed || isCompleted) && (
          ...
          >
            <span className="text-white fw-bold fs-5">
              {isCompleted ? "Tamamlandı" : "Kapatıldı"}
            </span>
          </div>
        )}
      </div>
      ...
      <div className="p-16 p-md-20 d-flex flex-column flex-grow-1">
        ...
        {/* Meta Container - Application Count */}
          ...
          <div className="soft-card rounded-16 mb-12">
            <div className="d-flex align-items-center gap-12 p-12">
              ...
              <div className="status-info flex-grow-1">
                <span
                  className="fw-bold text-primary-700 status-value"
