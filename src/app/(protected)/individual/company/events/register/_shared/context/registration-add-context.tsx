...
import type { EventRegistrationAddContextValue } from "@/app/(protected)/individual/company/events/register/_shared/types";
import {
  useGetEventById,
  useCreateRegistrationForm,
} from "@/app/(protected)/individual/company/events/register/_shared/hooks";
