...
// Mock-institutions.ts'den kopyalanan ve uyarlanan veriler
export const mockSchools: SchoolSearchResultDto[] = [
  {
    id: 1,
    name: "Başarı Koleji",
    slug: "basari-koleji",
...
export const getSchoolsWithActiveCampaigns = (): SchoolSearchResultDto[] => {
  return getSchoolsWithActiveCampaignsUtil(mockSchools);
};
...
export const getSchoolStats = () => {
  return calculateSchoolStats(mockSchools);
};
