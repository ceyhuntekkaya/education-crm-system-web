 ...
 */
export const getConfirmedAppointments = (appointments: AppointmentDto[]): AppointmentDto[] => {
 ...
 */
export const getCompletedAppointments = (appointments: AppointmentDto[]): AppointmentDto[] => {
 ...
 */
export const getCancelledAppointments = (appointments: AppointmentDto[]): AppointmentDto[] => {
 ...
 */
export const getPendingAppointments = (appointments: AppointmentDto[]): AppointmentDto[] => {
 ...
 */
export const getInProgressAppointments = (appointments: AppointmentDto[]): AppointmentDto[] => {
 ...
 */
export const getAppointmentsByType = (appointments: AppointmentDto[], appointmentType: string): AppointmentDto[] => {
  return appointments.filter(appointment => appointment.appointmentType === appointmentType);
};

/**
 * Get appointment by ID
 */
export const getAppointmentById = (appointments: AppointmentDto[], id: number): AppointmentDto | undefined => {
 ...
 */
export const calculateAppointmentStats = (appointments: AppointmentDto[]): AppointmentStats => {
  ...
  const appointmentsWithLikelihood = appointments.filter(a => a.enrollmentLikelihood !== undefined);
  const totalLikelihood = appointmentsWithLikelihood.reduce((sum, a) => sum + (a.enrollmentLikelihood || 0), 0);
  const averageEnrollmentLikelihood = appointmentsWithLikelihood.length > 0 
