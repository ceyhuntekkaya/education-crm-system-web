      ...
      <div className="bg-white/70 backdrop-blur-sm rounded p-4 border border-red-200 h-[520px] overflow-y-auto">
        {errorCount > 0 ? (
          <div className="space-y-4">
            ...
            {/* Placeholder içerik - daha fazla alan göstermek için */}
            {errorCount < 4 && (
              <div className="text-center py-12 text-gray-400">
                <div className="text-4xl mb-4">📝</div>
                <p className="text-sm mb-3">
                  Form alanlarını doldurmaya başladığınızda
                </p>
                <p className="text-sm mb-4">
                  validasyon hataları burada görünecek
                </p>
                <div className="bg-gray-100 rounded-lg p-3 text-gray-600 text-xs max-w-xs mx-auto">
                  <p>Kontrol edilen kurallar:</p>
                  <p>• Zorunlu alanlar</p>
                  <p>• Format kontrolleri</p>
                  <p>• Uzunluk sınırları</p>
                  <p>• Özel validasyonlar</p>
                </div>
              </div>
            )}
          </div>
