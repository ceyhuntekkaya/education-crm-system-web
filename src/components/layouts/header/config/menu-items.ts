...
export const menuItems: MenuItem[] = [
  ...
  },
  {
    ...
    href: "/fav-searches",
    links: [
      { href: "/search?favId=0", label: "Anaokulu Araması" },
      { href: "/search?favId=1", label: "İlkokul Araması" },
      { href: "/search?favId=2", label: "Ortaokul Araması" },
      { href: "/search?favId=3", label: "Lise Araması" },
