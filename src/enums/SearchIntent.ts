export enum SearchIntent {
  ...
  ACADEMIC = "ACADEMIC", // Akademik bilgi
  PRICE_COMPARISON = "PRICE_COMPARISON", // Fiyat karşılaştırma
  REVIEW_SEEKING = "REVIEW_SEEKING", // Değerlendirme arama
  CONTACT = "CONTACT", // İletişim bilgisi
  UNCLEAR = "UNCLEAR", // Belirsiz
}
